 ...
 */
define("HOST", "fdb13.biz.nf"); 			// The host you want to connect to. 
define("USER", "2072024_simple"); 			// The database username. 
define("PASSWORD", "9949249566A"); 	// The database password. 
define("DATABASE", "2072024_simple");             // The database name.
/**
